      ...
      >
        ...
        <div style={{ fontSize: '20px', marginLeft: '-150px' }}>
          ...
          <input
            ...
            type='text'
            placeholder='Search with Brands'
          />

          <p style={{ cursor: 'pointer', marginTop: '15px' }}>Brand</p>
          <hr />
          <p
          ...
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '7px', marginTop: '15px' }}
          >
            Model
          </p>
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '65px', marginTop: '15px' }}
          >
            Configuration
          </p>
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '35px', marginTop: '15px' }}
          >
            Resolution
          </p>
          <hr />
          ...
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '70px', marginTop: '15px' }}
          >
            Lens Included
          </p>
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '80px', marginTop: '15px' }}
          >
            Special Features
          </p>
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '40px', marginTop: '15px' }}
          >
            Viewfinder
          </p>
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '5px', marginTop: '15px' }}
          >
            Color
          </p>
          <hr />
          ...
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '-4px', marginTop: '15px' }}
          >
            Wifi
          </p>
          <hr />
          <p
            style={{ cursor: 'pointer', marginLeft: '10px', marginTop: '15px' }}
          >
            Edition
          </p>
          <hr />
              ...
              >
                ...
                <div style={{ width: '60%', marginRight: '100px' }}>
                  ...
                  <p style={{ marginRight: '80px' }}>
                    SKU:{el.product_sku_2} MFR:{el.product_sku_4} <br />
                ...
                <div>
                  ...
                  <p style={{ color: 'rgb(43, 105, 229)', cursor: 'pointer' }}>
                    + wishlist
                  </p>
                  <br />
                  <hr />
